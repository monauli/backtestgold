export type SavedMethod = { id: string; name: string; sourceRunId: string; strategyId: string; breakoutPips: number; stopLossPips: number; takeProfitPips: number; lot: number; initialBalance: number };
